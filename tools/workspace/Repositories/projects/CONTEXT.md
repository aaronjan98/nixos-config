...
| `arduino/` | active | Addressable LED desk-backlight sketches. Current ESP32 firmware serves the `desk-leds` web UI, OTA updates, audio-reactive FastLED animations, and logical LED power control. |
